...
def ui_full(launch_kwargs):
    with gr.Blocks() as interface:
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    model = gr.Radio(["facebook/musicgen-melody", 'Kee2001/musicGen'],
        ...
        gr.Examples(
            ...
            examples=[
                [
                    "A high-energy electronic track with a driving rhythm and pulsating beats. The bassline is heavy and deep.",
                    "assets/music_condition.wav",
                    "facebook/musicgen-melody",
                    "Default"
                ],
                [
                    "A high-energy Electronic track with elements of Psy-Trance, Trance, Goa Trance, Hard Trance, Tech Trance, and Hard House genres. Melodic and energetic in mood, it features the use of synthesizers, bass, samplers, keyboards, computers, drums, and drum machines",
                    "./assets/music_condition.wav",
                    "Kee2001/musicGen",
                    "Default"
                ],
                [
                    "A high-energy Electronic track with elements of Hard House, Donk, and Grime genres. Synthesizers dominate the melody while drums from a drummachine add rhythm. The mood is energetic with a slow tempo, making it suitable for late nights or dancefloors.",
                    None,
                    "Kee2001/musicGen",
                    "Default"
                ],
